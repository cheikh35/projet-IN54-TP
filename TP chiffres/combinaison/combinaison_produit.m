function [ vecteurs_proba_final , taux_reconnaissance ] = combinaison_produit( vecteurs_proba1 , vecteurs_proba2 )
...
% Sortie : 
%   vecteurs_proba_final : vecteurs de probabilité combinaison par produit
